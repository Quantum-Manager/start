...
- [исправлено]] Добавлены новые настройки для метатегов изображений. Добавлена новая библиотека jpel(https://github.com/Quantum-Manager/jpel) (поддерживается форматы jpg)
