...
- [новое][в разработке] Добавлена интеграция с SP Page Builder
- [исправлено] При вставке по кнопке "Изображения" не вставлялось позиционирование картинки
- [исправлено][в разработке] Удалена настройка "Разрешить загрузка архивов", вместо нее добавлен новый параметр "проверять содержимое архивов"
- [исправлено][в разработке] Важные метатеги сохраняются у картинок в формате при их изменении (поддерживается форматы jpg, tiff)
