...
- [исправлено] Вставка из буфера обмена картинок. Когда происходила вставка картинки в редактор, например, JCE или timyMCE, а менеджер был в поле спрятан и он захыватывал эту вставку тоже и загружал картинку в доступную область. Теперь чтобы загрузить картинку из буфера надо кликнуть где-то внутри менеджера, чтобы сделать его "активным"
