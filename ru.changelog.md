3.0.1  
- [исправлено] Отображение превью svg файлов
- [исправлено] Алгоритм создания папок (если их нет), при загрузке файлов

3.0.0
- [новое] Удаление legacy кода от Joomla 3.x
- [новое] Совместимость с Joomla 5.x
- [новое] Новая темная тема для Joomla 5.x
- [исправлено] Ошибка, что файлы сохранялись в корне Joomla
- [исправлено] Генерация кеша и отдача
- [исправлено] Ошибки в генерации watermark

2.0.0
- [новое] Адаптация под joomla 4. Не работает пока замена полей в компоненте com_fields. Так же пока нет перехвата модальных окон от встроенного в Joomla 4 файлового менеджера. В joomla 3 сохранена вся функциональность
...
- [новое] Добавлена настройка: открытие папки, по одному клику или по двумя
- [новое] Добавлена настройка: разрешить создание изображения из буфера обмена
...
- [исправлено] Ошибка при загрузке, если сервер не позволял загружать больше указанного максимального размера файла
...
- [улучшено] Кнопки назад и вверх были перенесены вправо к остальным кнопкам в тулбаре.
- [улучшено] Показ ошибок при ошибки загрузок файла, они сделаны как уведомления вместо модального окна
- [улучшено] Автовключения плагина для YOOtheme Pro

Список горячих клавиш:
- delete - удалить
- f2 -  перенименовать
- ctrl+c/command+c - копировать
- ctrl+x/command+x  вырезать
- ctrl+v/command+v - вставить
